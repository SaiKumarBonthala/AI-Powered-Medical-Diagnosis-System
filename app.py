...
background_image_url = "https://ehealth4everyone.com/wp-content/uploads/2023/01/Blog-Header-1200x600-px-3.png"  # Replace with your image URL
...
if selected == "Lung Cancer Prediction":
    ...
    if st.button("Lung Cancer Test Result"):
        lungs_prediction = models['lungs_cancer'].predict([[GENDER, AGE, SMOKING, YELLOW_FINGERS, ANXIETY, PEER_PRESSURE, CHRONIC_DISEASE, FATIGUE, ALLERGY, WHEEZING, ALCOHOL_CONSUMING, COUGHING, SHORTNESS_OF_BREATH, SWALLOWING_DIFFICULTY, CHEST_PAIN]])
